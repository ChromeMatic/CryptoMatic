...
export default {
  ...
  computed:{
      ...mapGetters(["getTheme","getCryptoByID","getCryptoChartInfo","getCryptoMarketData"]),
...
<template>
  <div :class="getTheme ? 'dark' : ''">
    <div class="dark:bg-dashC w-full flex flex-col justify-center items-center px-8 py-4 space-y-4">
      ...
      <div class="rounded w-full grid gap-2 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-1">
          <p class="text-gray-700 dark:bg-gray-900 bg-pr1 text-center xl:px-8 py-4 xl:py-8 px-4 rounded dark:text-white uppercase font-semibold">
          ...
          <p class="text-gray-700 dark:bg-gray-900 bg-pr1 text-center xl:px-8 py-4 xl:py-8 px-4  dark:text-white uppercase font-semibold">
